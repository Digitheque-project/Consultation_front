export function openSummaryWindow(title: string, content: string) {
  ...
  w.document.write(
    ...
    'h1{font-size:22px;color:#003178;margin-bottom:24px}' +
    '.card{background:#f8fafc;border-radius:14px;padding:20px;margin-bottom:16px;box-shadow:0 1px 4px rgba(0,0,0,.04)}' +
