...
} from "@/lib/api/instances/dashboard";
import type {
  DashboardStats,
...
const formatCount = (value: number, pad: number = 0) =>
...
export default function DashboardPage() {
  ...
  const hospitalizedQuery = useQuery<HospitalizedPatient[]>({
    queryKey: ["dashboard-hospitalized"],
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
        ...
        <div className="space-y-8">
          ...
          <div className="bg-[#F5F8FA] rounded-[28px] sm:rounded-[32px] p-5 sm:p-7 border border-[#EAF3FA]">
            <h3 className="text-[10px] sm:text-[11px] font-extrabold text-[#006A8C] uppercase tracking-[0.1em] mb-5 sm:mb-6">ACCÈS RAPIDES</h3>
            <div className="space-y-4">
              <button className="w-full bg-white hover:bg-gray-50 transition-colors text-left px-4 sm:px-5 py-3.5 sm:py-4.5 rounded-2xl flex items-center gap-3 sm:gap-4 shadow-sm border border-transparent">
                <Calendar className="w-5 h-5 text-[#006A8C]" strokeWidth={2.5} />
                <span className="text-[12px] sm:text-[13px] font-bold text-gray-900 leading-snug">Mon planning complet</span>
              </button>
            </div>
          </div>
          ...
          <div className="bg-white rounded-[28px] sm:rounded-[32px] p-5 sm:p-7 shadow-[0px_4px_16px_rgba(17,17,26,0.05)] border border-gray-100">
            <h3 className="text-[10px] sm:text-[11px] font-extrabold text-gray-400 uppercase tracking-[0.1em] mb-5 sm:mb-6">ÉQUIPE DE GARDE</h3>
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] sm:text-[11px] font-medium text-gray-400">Anesthésiste - Réanimateur</p>
                  </div>
                </div>
